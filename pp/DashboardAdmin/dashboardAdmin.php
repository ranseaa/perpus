...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid p-3">
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../assets/adminlogo.jpg" alt="adminLogo" width="40px">
          </button>
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          <li>
            <a class="dropdown-item text-center" href="#">
            <img src="../assets/adminlogo.jpg" alt="adminLogo" width="30px">
            </a>
          </li>
          <li>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard ChooseNRead</div>
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Siti Ratna J.</span> © 2024</p>
      <p class="mt-2">Budayakan Membaca</p>
      </div>
    </footer>
